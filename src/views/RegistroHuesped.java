	...
	public RegistroHuesped() {
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				frame.setVisible(true);
				frame.llenarCampos(RegistrarReserva.reservacion);
				dispose();				
			}
			@Override
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (txtNombre.getText() != "" && txtApellido.getText() != "" && txtFechaN.getDate() != null && txtTelefono.getText() != "") {
					Huesped huesped = new Huesped(
						txtNombre.getText(), 
						txtApellido.getText(), 
						txtFechaN.getDate().getTime(),
						txtNacionalidad.getSelectedItem().toString(),
						txtTelefono.getText()
						);
					RegistrarReserva.setHuesped(huesped);
					boolean exito = RegistrarReserva.registrarReservacion();
