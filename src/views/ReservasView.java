...
public class ReservasView extends JFrame {
	...
	private int costoHabitacionPorDia = 350;
	private int costoReservacion = 0;
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 136, 190, 14);
		...
		lblSiguiente.setBounds(0, 0, 200, 35);
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (entrada != null && salida != null) {
					int dias = (int) (salida.getTime() - entrada.getTime()) / (1000 * 3600 * 24);
					costoReservacion = costoHabitacionPorDia * dias;
					txtValor = new JTextField("$" + costoReservacion + " MXN");
					txtValor.setBackground(SystemColor.text);
					txtValor.setHorizontalAlignment(SwingConstants.CENTER);
					txtValor.setForeground(Color.GREEN);
					txtValor.setBounds(68, 340, 290, 20);
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					Reserva reserva = new Reserva(
							...
							txtFechaSalida.getDate().getTime(),
							costoReservacion,
							txtFormaPago.getSelectedItem().toString()
							);
					
					RegistrarReserva.setReserva(reserva);
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    public void llenarCampos(Reserva reservacion) {
			txtFechaEntrada.setDate(reservacion.getFechaEntrada());
			txtFechaSalida.setDate(reservacion.getFechaSalida());
			txtFormaPago.setSelectedItem(reservacion.getFormaPago());
		}
}
